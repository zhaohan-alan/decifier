...
#  "--dataset-name chili_none_N-0p05_B-0p05 --add-noise 0.05 --add-broadening 0.05"
#  "--dataset-name chili_comp_N-0p05_B-0p05 --add-composition --add-noise 0.05 --add-broadening 0.05"
#  "--dataset-name chili_compSG_N-0p05_B-0p05 --add-composition --add-spacegroup --add-noise 0.05 --add-broadening 0.05"
#
#  "--dataset-name chili_none_N-0p00_B-0p10 --add-broadening 0.10"
#  "--dataset-name chili_comp_N-0p00_B-0p10 --add-composition --add-broadening 0.10"
#  "--dataset-name chili_compSG_N-0p00_B-0p10 --add-composition --add-spacegroup --add-broadening 0.10"
#
#  "--dataset-name chili_none_N-0p05_B-0p10 --add-noise 0.05 --add-broadening 0.10"
#  "--dataset-name chili_comp_N-0p05_B-0p10 --add-composition --add-noise 0.05 --add-broadening 0.10"
#  "--dataset-name chili_compSG_N-0p05_B-0p10 --add-composition --add-spacegroup --add-noise 0.05 --add-broadening 0.10"
# 
#  # OOD
#  "--dataset-name chili_none_N-0p10_B-0p05 --add-noise 0.10 --add-broadening 0.05"
#  "--dataset-name chili_none_N-0p00_B-0p20 --add-broadening 0.20"
#  "--dataset-name chili_none_N-0p10_B-0p20 --add-noise 0.10 --add-broadening 0.20"
